...
function loadLogin(datas) {
    ...
    document.querySelector('.modal-body').style.background = "radial-gradient(#3399ff, #00cc66, #009999)";
    document.querySelector('.modal-header').style.background = "linear-gradient(to right, #009999, rgba(51, 153, 255, 0.1))";
    ...
    <form>
        ...
        <div class="also" style=" position: relative; margin: 2px auto; left: 25px;">
            <input type="checkbox" name="remember" id="remember">
            <label for="remember">Remember me</label>
            <a class="forgot" onclick="forgot()" style="padding-left: 25%; text-align: right; font-style: italic;">Forgot Password?</a>
        </div>
    </form>
